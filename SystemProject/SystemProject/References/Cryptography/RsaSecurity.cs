    ...
    public class RsaSecurity
    {
       public static RSA Create()
       {
            ...
            HashAlgorithmName hashAlg, RSASignaturePadding padding = null!)
        {
            ...
            byte[] signedBytes = rsa.SignData(plainBytes, hashAlg, padding?? RSASignaturePadding.Pss);
            ...
            HashAlgorithmName hashAlg, RSASignaturePadding padding = null!)
        {
            ...
            return rsa.VerifyData(plainBytes, signature, hashAlg, padding ?? RSASignaturePadding.Pss);
        }
    }
}
