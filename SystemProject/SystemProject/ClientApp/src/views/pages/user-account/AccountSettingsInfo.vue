<template>
 ...
 <notificationGroup group="top">
    ...
    <notificationGroup group="bottom" position="bottom">
      <div class="fixed inset-x-10 bottom-5 flex px-2 py-4 p-4 items-start justify-end">
        <div class="max-w-sm max-h-96">
          <notification v-slot="{notifications}">
            <div
              class="flex max-w-sm w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden mt-2"
              v-for="notification in notifications"
              :key="notification.id"
            >
